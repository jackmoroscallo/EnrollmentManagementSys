...
namespace EnrollmentManagementSys.Controllers
{
    public class PaymentTypesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("PaymentTypeID,PaymentTypeName")] PaymentType paymentType)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(Guid id, [Bind("PaymentTypeID,PaymentTypeName")] PaymentType paymentType)
        {
